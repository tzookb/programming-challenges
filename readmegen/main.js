...
const directories = [
  ...
  'exercises/facebookrecruiting',
  'exercises/codesignal',
];
...
const final = async _ => {
  ...
  const codesignalExercise = await getExercises(directories[3])  
  const codesignalMd = createMdSection('Codesignal', codesignalExercise)
